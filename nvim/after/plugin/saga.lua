...
set("n", "<leader><leader>r", "<cmd>Lspsaga rename<CR>", options)
set("n", "gd", "<cmd>Lspsaga goto_definition<CR>", options)
set("n", "<M-d>", "<cmd>Lspsaga peek_definition<CR>", options)
set("n", "<M-t>", "<cmd>Lspsaga peek_type_definition<CR>", options)
set("n", "gt", "<cmd>Lspsaga goto_type_definition<CR>", options)
set("n", "<leader>l", "<cmd>Lspsaga show_line_diagnostics<CR>", options)
set("n", "<leader><leader>i", "<cmd>Lspsaga show_cursor_diagnostics<CR>", options)
...
set("n", "<leader><leader>o", "<cmd>Lspsaga outline<CR>", options)
