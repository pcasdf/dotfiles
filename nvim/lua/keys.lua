...
set("n", "<C-q>", "<cmd>bd<cr>", { desc = "Close buffer" })
...
set("n", "[q", "<cmd>cprevious<cr>", { desc = "Previous in qflist" })
set("n", "]q", "<cmd>cnext<cr>", { desc = "Next in qflist" })
set("n", "[l", "<cmd>lprevious<cr>", { desc = "Previous in loclist" })
set("n", "]l", "<cmd>lnext<cr>", { desc = "Next in loclist" })
...
set("n", "<leader>oq", "<cmd>copen<cr>", { desc = "Open qflist" })
set("n", "<leader>ol", "<cmd>lopen<cr>", { desc = "Open loclist" })
